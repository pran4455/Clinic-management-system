...
class Graph:
    ...
    def add_edge_disease(self,node1,node2,node3="-",node4="-"):
        if node1 in self.graph and node2 in self.graph and node3 in self.graph and node4 in self.graph:
        ...
        elif node3 not in self.graph and node2 in self.graph and node3 in self.graph and node4 in self.graph:
        ...
        elif node4 not in self.graph and node2 in self.graph and node3 in self.graph and node4 in self.graph:
        ...
        elif node1 in self.graph and node2 in self.graph and node3 not in self.graph and node4 not in self.graph:
