...
urlpatterns = [
    ...
    path('receptionist/appointment-search-patient/', views.receptionist_book_appointment, name="receptionist_book_appointment"),
    path('receptionist/appointment-history/', views.receptionist_view_appointments, name='receptionist_view_appointments'),
    path('receptionist/book-appointment/', views.book_local_appointment, name="book_local_appointment"),
    path('receptionist/view-local-appointments/', views.receptionist_view_local_appointments, name="receptionist_view_local_appointments"),
